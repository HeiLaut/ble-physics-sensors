...
#define SDA 16 //PIN for I2C SDA
#define SCL 17 //PIN for I2C SCL

#define BLENAME "Laser-Distanz 0-400cm"
...
void setup() {
  ...
  Serial.println("-----------------------------");
  Serial.println("Vl53l1X-Sensor Version 0.4");
  Serial.println("-----------------------------");
